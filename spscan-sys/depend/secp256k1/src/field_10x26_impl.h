...
SECP256K1_INLINE static void bwkspscan_v0_1_0_fe_impl_set_int(bwkspscan_v0_1_0_fe *r, int a) {
    r->n[0] = a;
    r->n[1] = r->n[2] = r->n[3] = r->n[4] = r->n[5] = r->n[6] = r->n[7] = r->n[8] = r->n[9] = 0;
}

SECP256K1_INLINE static int bwkspscan_v0_1_0_fe_impl_is_zero(const bwkspscan_v0_1_0_fe *a) {
    const uint32_t *t = a->n;
    return (t[0] | t[1] | t[2] | t[3] | t[4] | t[5] | t[6] | t[7] | t[8] | t[9]) == 0;
}

SECP256K1_INLINE static int bwkspscan_v0_1_0_fe_impl_is_odd(const bwkspscan_v0_1_0_fe *a) {
    return a->n[0] & 1;
}
...
SECP256K1_INLINE static void bwkspscan_v0_1_0_fe_impl_negate_unchecked(bwkspscan_v0_1_0_fe *r, const bwkspscan_v0_1_0_fe *a, int m) {
...
SECP256K1_INLINE static void bwkspscan_v0_1_0_fe_impl_mul_int_unchecked(bwkspscan_v0_1_0_fe *r, int a) {
    r->n[0] *= a;
    r->n[1] *= a;
    r->n[2] *= a;
    r->n[3] *= a;
...
SECP256K1_INLINE static void bwkspscan_v0_1_0_fe_impl_add(bwkspscan_v0_1_0_fe *r, const bwkspscan_v0_1_0_fe *a) {
    r->n[0] += a->n[0];
    r->n[1] += a->n[1];
    r->n[2] += a->n[2];
    r->n[3] += a->n[3];
...
SECP256K1_INLINE static void bwkspscan_v0_1_0_fe_impl_add_int(bwkspscan_v0_1_0_fe *r, int a) {
    r->n[0] += a;
}
...
void bwkspscan_v0_1_0_fe_mul_inner(uint32_t *r, const uint32_t *a, const uint32_t * SECP256K1_RESTRICT b);
void bwkspscan_v0_1_0_fe_sqr_inner(uint32_t *r, const uint32_t *a);

#else

#define VERIFY_BITS(x, n) VERIFY_CHECK(((x) >> (n)) == 0)

SECP256K1_INLINE static void bwkspscan_v0_1_0_fe_mul_inner(uint32_t *r, const uint32_t *a, const uint32_t * SECP256K1_RESTRICT b) {
    uint64_t c, d;
...
SECP256K1_INLINE static void bwkspscan_v0_1_0_fe_sqr_inner(uint32_t *r, const uint32_t *a) {
    uint64_t c, d;
    uint64_t u0, u1, u2, u3, u4, u5, u6, u7, u8;
...
SECP256K1_INLINE static void bwkspscan_v0_1_0_fe_impl_mul(bwkspscan_v0_1_0_fe *r, const bwkspscan_v0_1_0_fe *a, const bwkspscan_v0_1_0_fe * SECP256K1_RESTRICT b) {
    bwkspscan_v0_1_0_fe_mul_inner(r->n, a->n, b->n);
}

SECP256K1_INLINE static void bwkspscan_v0_1_0_fe_impl_sqr(bwkspscan_v0_1_0_fe *r, const bwkspscan_v0_1_0_fe *a) {
    bwkspscan_v0_1_0_fe_sqr_inner(r->n, a->n);
}

SECP256K1_INLINE static void bwkspscan_v0_1_0_fe_impl_cmov(bwkspscan_v0_1_0_fe *r, const bwkspscan_v0_1_0_fe *a, int flag) {
...
static SECP256K1_INLINE void bwkspscan_v0_1_0_fe_impl_half(bwkspscan_v0_1_0_fe *r) {
    uint32_t t0 = r->n[0], t1 = r->n[1], t2 = r->n[2], t3 = r->n[3], t4 = r->n[4],
             t5 = r->n[5], t6 = r->n[6], t7 = r->n[7], t8 = r->n[8], t9 = r->n[9];
...
static SECP256K1_INLINE void bwkspscan_v0_1_0_fe_storage_cmov(bwkspscan_v0_1_0_fe_storage *r, const bwkspscan_v0_1_0_fe_storage *a, int flag) {
    uint32_t mask0, mask1;
    volatile int vflag = flag;
    SECP256K1_CHECKMEM_CHECK_VERIFY(r->n, sizeof(r->n));
    mask0 = vflag + ~((uint32_t)0);
...
static SECP256K1_INLINE void bwkspscan_v0_1_0_fe_impl_from_storage(bwkspscan_v0_1_0_fe *r, const bwkspscan_v0_1_0_fe_storage *a) {
...
static void bwkspscan_v0_1_0_fe_from_signed30(bwkspscan_v0_1_0_fe *r, const bwkspscan_v0_1_0_modinv32_signed30 *a) {
    ...
    /* The output from bwkspscan_v0_1_0_modinv32{_var} should be normalized to range [0,modulus), and
...
static void bwkspscan_v0_1_0_fe_to_signed30(bwkspscan_v0_1_0_modinv32_signed30 *r, const bwkspscan_v0_1_0_fe *a) {
...
static const bwkspscan_v0_1_0_modinv32_modinfo bwkspscan_v0_1_0_const_modinfo_fe = {
    {{-0x3D1, -4, 0, 0, 0, 0, 0, 0, 65536}},
    0x2DDACACFL
};

static void bwkspscan_v0_1_0_fe_impl_inv(bwkspscan_v0_1_0_fe *r, const bwkspscan_v0_1_0_fe *x) {
    bwkspscan_v0_1_0_fe tmp = *x;
    bwkspscan_v0_1_0_modinv32_signed30 s;

    bwkspscan_v0_1_0_fe_normalize(&tmp);
    bwkspscan_v0_1_0_fe_to_signed30(&s, &tmp);
    bwkspscan_v0_1_0_modinv32(&s, &bwkspscan_v0_1_0_const_modinfo_fe);
    bwkspscan_v0_1_0_fe_from_signed30(r, &s);
}
...
static void bwkspscan_v0_1_0_fe_impl_inv_var(bwkspscan_v0_1_0_fe *r, const bwkspscan_v0_1_0_fe *x) {
    ...
    bwkspscan_v0_1_0_fe_normalize_var(&tmp);
    bwkspscan_v0_1_0_fe_to_signed30(&s, &tmp);
    bwkspscan_v0_1_0_modinv32_var(&s, &bwkspscan_v0_1_0_const_modinfo_fe);
    bwkspscan_v0_1_0_fe_from_signed30(r, &s);
}

static int bwkspscan_v0_1_0_fe_impl_is_square_var(const bwkspscan_v0_1_0_fe *x) {
    bwkspscan_v0_1_0_fe tmp;
    bwkspscan_v0_1_0_modinv32_signed30 s;
    int jac, ret;

    tmp = *x;
    bwkspscan_v0_1_0_fe_normalize_var(&tmp);
    /* bwkspscan_v0_1_0_jacobi32_maybe_var cannot deal with input 0. */
    if (bwkspscan_v0_1_0_fe_is_zero(&tmp)) return 1;
    bwkspscan_v0_1_0_fe_to_signed30(&s, &tmp);
    jac = bwkspscan_v0_1_0_jacobi32_maybe_var(&s, &bwkspscan_v0_1_0_const_modinfo_fe);
    if (jac == 0) {
        /* bwkspscan_v0_1_0_jacobi32_maybe_var failed to compute the Jacobi symbol. Fall back
         * to computing a square root. This should be extremely rare with random
         * input (except in VERIFY mode, where a lower iteration count is used). */
        bwkspscan_v0_1_0_fe dummy;
        ret = bwkspscan_v0_1_0_fe_sqrt(&dummy, &tmp);
    } else {
        ret = jac >= 0;
    }
    return ret;
