...
use crate::silentpayments::utils as sp_utils;
use crate::silentpayments::{Network as SpNetwork, SilentPaymentAddress};

use crate::spdk_core::error::{Error, Result};

use crate::spdk_core::constants::{DATA_CARRIER_SIZE, NUMS};
...
impl SpClient {
    ...
    pub fn finalize_transaction(
        ...
        let sp_address2xonlypubkeys = crate::silentpayments::sending::generate_recipient_pubkeys(
            sp_addresses,
...
mod tests {
    use super::*;
    use crate::spdk_core::client::{OutputSpendStatus, OwnedOutput, Recipient, RecipientAddress};
