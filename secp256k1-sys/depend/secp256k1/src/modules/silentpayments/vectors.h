...
#define SECP256K1_SILENTPAYMENTS_NUMBER_TESTVECTORS (29)
...
static const struct bip352_test_vector bip352_test_vectors[SECP256K1_SILENTPAYMENTS_NUMBER_TESTVECTORS] = {
    ...
    /* ----- Input keys intermediate sum is zero but final sum is non-zero (26) ----- */
    {
        3,
        { /* input plain seckeys */
            {0xa6,0xdf,0x6a,0x0b,0xb4,0x48,0x99,0x2a,0x30,0x1d,0xf4,0x25,0x8e,0x06,0xa8,0x9f,0xe7,0xcf,0x71,0x46,0xf5,0x9a,0xc3,0xbd,0x5f,0xf2,0x60,0x83,0xac,0xb2,0x2c,0xeb},
    ...
    /* ----- Lightclient equivalence: no labels (27) ----- */
    {
        2,
        { /* input plain seckeys */
            {0xea,0xdc,0x78,0x16,0x5f,0xf1,0xf8,0xea,0x94,0xad,0x7c,0xfd,0xc5,0x49,0x90,0x73,0x8a,0x4c,0x53,0xf6,0xe0,0x50,0x7b,0x42,0x15,0x42,0x01,0xb8,0xe5,0xdf,0xf3,0xb1},
        ...
        1, /* lightclient equivalence */
    },

    /* ----- Lightclient equivalence: one label (28) ----- */
    {
        2,
        { /* input plain seckeys */
            {0xea,0xdc,0x78,0x16,0x5f,0xf1,0xf8,0xea,0x94,0xad,0x7c,0xfd,0xc5,0x49,0x90,0x73,0x8a,0x4c,0x53,0xf6,0xe0,0x50,0x7b,0x42,0x15,0x42,0x01,0xb8,0xe5,0xdf,0xf3,0xb1},
    ...
    /* ----- Lightclient equivalence: many labels (29) ----- */
    {
        2,
        { /* input plain seckeys */
            {0xea,0xdc,0x78,0x16,0x5f,0xf1,0xf8,0xea,0x94,0xad,0x7c,0xfd,0xc5,0x49,0x90,0x73,0x8a,0x4c,0x53,0xf6,0xe0,0x50,0x7b,0x42,0x15,0x42,0x01,0xb8,0xe5,0xdf,0xf3,0xb1},
