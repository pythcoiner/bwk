 ...
 * the table cannot have infinities in them (bwkspscan_v0_1_0_ge_storage
...
typedef struct {
    ...
    bwkspscan_v0_1_0_scalar scalar_offset;
    bwkspscan_v0_1_0_ge ge_offset;

    /* Factor used for projective blinding. This value is used to rescale the Z
     * coordinate of the first table lookup. */
    bwkspscan_v0_1_0_fe proj_blind;
} bwkspscan_v0_1_0_ecmult_gen_context;
...
static void bwkspscan_v0_1_0_ecmult_gen(const bwkspscan_v0_1_0_ecmult_gen_context* ctx, bwkspscan_v0_1_0_gej *r, const bwkspscan_v0_1_0_scalar *a);
