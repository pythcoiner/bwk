...
impl<B: ChainBackend, U: Updater> SpAccount<B, U> {
    ...
    pub fn restore(
        ...
        updater: U,
        stop: Arc<AtomicBool>,
    ) -> crate::spdk_core::error::Result<Self> {
    ...
    pub fn block_height(&self) -> crate::spdk_core::error::Result<Height> {
    ...
    pub fn spend_key(&self, secp: &secp256k1::Secp256k1<All>) -> PublicKey {
        match self.client.get_spend_key() {
            crate::spdk_core::SpendKey::Secret(secret_key) => secret_key.public_key(secp),
            crate::spdk_core::SpendKey::Public(pubkey) => pubkey,
        }
    }
}
...
impl<B: ChainBackend + MaybeSync, U: Updater + MaybeSync> SpScanner for SpAccount<B, U> {
    fn scan_blocks(
        ...
        if start > end {
            return Err(crate::spdk_core::error::Error::InvalidRange(
        ...
        let owned = crate::spdk_core::scanner::process_two_phase(
            self,
            start,
            end,
            dust_limit,
    ...
    fn match_block_outputs(
        &self,
        blockdata: &crate::spdk_core::BlockData,
    ) -> crate::spdk_core::error::Result<
    ...
    ) -> crate::spdk_core::error::Result<std::collections::HashMap<[u8; 8], bitcoin::OutPoint>>
    {
...
mod tests {
    use super::*;
    use crate::spdk_core::{updater::DummyUpdater, SpentIndexData, Updater, UtxoData};
    ...
    impl ChainBackend for MockBackend {
        ...
        fn spent_index(
            &self,
            _block_height: Height,
        ) -> crate::spdk_core::error::Result<SpentIndexData> {
            Ok(SpentIndexData { data: vec![] })
        }

        fn utxos(&self, _block_height: Height) -> crate::spdk_core::error::Result<Vec<UtxoData>> {
            Ok(vec![])
        }
    ...
    impl Updater for MockUpdater {
        ...
        fn restore_owned_outpoints(&self) -> crate::spdk_core::error::Result<HashSet<OutPoint>> {
    ...
    fn test_spend_sweep_covers_lagging_frontier_below_start() {
        ...
        impl Updater for LagUpdater {
            ...
            fn spend_frontier(&self) -> crate::spdk_core::error::Result<Option<u32>> {
                Ok(self.frontier)
            }
        }
