...
int main(void) {
    ...
    /*** Receiving ***/
    {
...

        {
            ...
            rustsecp256k1_v0_10_0_pubkey address_labeled_spend_pubkey;
            ...
            }
            {
                 ...
                 * called
                 * `rustsecp256k1_v0_10_0_silentpayments_recipient_create_labeled_spend_pubkey`
                 ...
                 */
                ret = rustsecp256k1_v0_10_0_silentpayments_recipient_create_labeled_spend_pubkey(ctx,
                ...
                assert(ret);
                if (rustsecp256k1_v0_10_0_ec_pubkey_cmp(ctx, &labeled_spend_pubkey, &address_labeled_spend_pubkey) != 0) {
                    printf("\n");
             ...
             * creates a `rustsecp256k1_v0_10_0_silentpayments_recipient_public_data` object. He uses
