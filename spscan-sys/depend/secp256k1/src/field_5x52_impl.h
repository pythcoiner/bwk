...
static void bwkspscan_v0_1_0_fe_from_signed62(bwkspscan_v0_1_0_fe *r, const bwkspscan_v0_1_0_modinv64_signed62 *a) {
...
static void bwkspscan_v0_1_0_fe_to_signed62(bwkspscan_v0_1_0_modinv64_signed62 *r, const bwkspscan_v0_1_0_fe *a) {
...
static const bwkspscan_v0_1_0_modinv64_modinfo bwkspscan_v0_1_0_const_modinfo_fe = {
...
static void bwkspscan_v0_1_0_fe_impl_inv(bwkspscan_v0_1_0_fe *r, const bwkspscan_v0_1_0_fe *x) {
    ...
    bwkspscan_v0_1_0_fe_to_signed62(&s, &tmp);
    bwkspscan_v0_1_0_modinv64(&s, &bwkspscan_v0_1_0_const_modinfo_fe);
    bwkspscan_v0_1_0_fe_from_signed62(r, &s);
}
...
static void bwkspscan_v0_1_0_fe_impl_inv_var(bwkspscan_v0_1_0_fe *r, const bwkspscan_v0_1_0_fe *x) {
    ...
    bwkspscan_v0_1_0_fe_to_signed62(&s, &tmp);
    bwkspscan_v0_1_0_modinv64_var(&s, &bwkspscan_v0_1_0_const_modinfo_fe);
    bwkspscan_v0_1_0_fe_from_signed62(r, &s);
}
...
static int bwkspscan_v0_1_0_fe_impl_is_square_var(const bwkspscan_v0_1_0_fe *x) {
    ...
    tmp = *x;
    bwkspscan_v0_1_0_fe_normalize_var(&tmp);
    /* bwkspscan_v0_1_0_jacobi64_maybe_var cannot deal with input 0. */
    if (bwkspscan_v0_1_0_fe_is_zero(&tmp)) return 1;
    bwkspscan_v0_1_0_fe_to_signed62(&s, &tmp);
    jac = bwkspscan_v0_1_0_jacobi64_maybe_var(&s, &bwkspscan_v0_1_0_const_modinfo_fe);
    if (jac == 0) {
        /* bwkspscan_v0_1_0_jacobi64_maybe_var failed to compute the Jacobi symbol. Fall back
