...
//! To do this, you can use [`calculate_partial_secret`](crate::silentpayments::utils::sending::calculate_partial_secret) from the `utils` module.
//! See the [tests on github](https://github.com/cygnet3/rust-silentpayments/blob/master/tests/vector_tests.rs)
//! for a concrete example.

use crate::silentpayments::secp256k1::{PublicKey, Secp256k1, SecretKey, XOnlyPublicKey};
use std::collections::HashMap;

use crate::silentpayments::utils::common::calculate_t_n;
use crate::silentpayments::utils::sending::calculate_ecdh_shared_secret;
