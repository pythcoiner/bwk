...
use crate::silentpayments::secp256k1::{ecdh::shared_secret_point, Parity::Even, XOnlyPublicKey};
use crate::silentpayments::secp256k1::{PublicKey, SecretKey};
...
pub fn calculate_tweak_data(
    ...
    let secp = crate::silentpayments::secp256k1::Secp256k1::verification_only();
...
/// This function returns the shared secret of this transaction. This shared secret can be used to scan the transaction of outputs that are for the current user. See [`Receiver::scan_transaction`](crate::silentpayments::receiving::Receiver::scan_transaction).
