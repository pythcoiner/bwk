...
/**
 * Same as bwkspscan_v0_1_0_ecmult_const, but takes in an x coordinate of the base point
 ...
 */
static int bwkspscan_v0_1_0_ecmult_const_xonly(
    bwkspscan_v0_1_0_fe *r,
    const bwkspscan_v0_1_0_fe *n,
    const bwkspscan_v0_1_0_fe *d,
    const bwkspscan_v0_1_0_scalar *q,
    int known_on_curve
);
