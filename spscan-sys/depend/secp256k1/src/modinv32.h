...
typedef struct {
    int32_t v[9];
} bwkspscan_v0_1_0_modinv32_signed30;

typedef struct {
    /* The modulus in signed30 notation, must be odd and in [3, 2^256]. */
    bwkspscan_v0_1_0_modinv32_signed30 modulus;

    /* modulus^{-1} mod 2^30 */
    uint32_t modulus_inv30;
} bwkspscan_v0_1_0_modinv32_modinfo;
...
/* Same as bwkspscan_v0_1_0_modinv32_var, but constant time in x (not in the modulus). */
