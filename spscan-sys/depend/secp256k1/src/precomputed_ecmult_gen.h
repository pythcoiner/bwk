...
static bwkspscan_v0_1_0_ge_storage bwkspscan_v0_1_0_ecmult_gen_prec_table[COMB_BLOCKS][COMB_POINTS];
#else
SECP256K1_LOCAL_VAR const bwkspscan_v0_1_0_ge_storage bwkspscan_v0_1_0_ecmult_gen_prec_table[COMB_BLOCKS][COMB_POINTS];
